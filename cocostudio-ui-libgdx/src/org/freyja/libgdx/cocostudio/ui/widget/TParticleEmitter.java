...
public class TParticleEmitter {
    ...
    CCParticleBean ccParticleBean;

    public TParticleEmitter () {
        initialize();
    }

    public TParticleEmitter (BufferedReader reader) throws IOException {
        initialize();
        load(reader);
    }

    public TParticleEmitter(CCParticleBean ccParticleBean){
        initialize();
        this.ccParticleBean = ccParticleBean;
        load(ccParticleBean);
    }

    public TParticleEmitter (TParticleEmitter emitter) {
    ...
    private void load(CCParticleBean ccParticleBean) {
            //name = readString(reader, "name");
            name = ccParticleBean.getTextureFileName();

           // delayValue.load(reader);
           // reader.readLine();
            durationValue.load(new RangedNumericValue(ccParticleBean.getDuration()));
            //reader.readLine();
            setMinParticleCount(0);
            //setMinParticleCount(readInt(reader, "minParticleCount"));
            //setMaxParticleCount(readInt(reader, "maxParticleCount"));
            setMaxParticleCount(ccParticleBean.getMaxParticles());
            //reader.readLine();
            /*emissionValue.load(reader);
    ...
    static public class RangedNumericValue extends ParticleValue {
        ...
        public RangedNumericValue(float value) {
            this.lowMin = value;
            this.lowMax = value;
        }
    ...
    static public class ScaledNumericValue extends RangedNumericValue {
        ...
        public ScaledNumericValue(float lowMin, float lowMax, float[] scaling, float[] timeline, float highMin, float highMax, boolean relative) {
            super(lowMin, lowMax);

...
public class CCParticleBean {
    ...
    double rotationEnd;
    double rotationEndVariance;
    double rotationStart;
    double rotationStartVariance;
    ...
    public void setAngleVariance(int angleVariance) {
        this.angleVariance = angleVariance;
    }

    public int getBlendFuncDestination() {
        return blendFuncDestination;
    }

    public void setBlendFuncDestination(int blendFuncDestination) {
        this.blendFuncDestination = blendFuncDestination;
    }

    public int getBlendFuncSource() {
        return blendFuncSource;
    }

    public void setBlendFuncSource(int blendFuncSource) {
        this.blendFuncSource = blendFuncSource;
    }
    ...
    public double getEmitterType() {
        return emitterType;
    }

    public void setEmitterType(double emitterType) {
    ...
    public double getFinishParticleSize() {
        return finishParticleSize;
    }

    public void setFinishParticleSize(double finishParticleSize) {
        this.finishParticleSize = finishParticleSize;
    }

    public double getFinishParticleSizeVariance() {
        return finishParticleSizeVariance;
    }

    public void setFinishParticleSizeVariance(double finishParticleSizeVariance) {
    ...
    public double getRotatePerSecond() {
        return rotatePerSecond;
    }

    public void setRotatePerSecond(double rotatePerSecond) {
        this.rotatePerSecond = rotatePerSecond;
    }

    public double getRotatePerSecondVariance() {
        return rotatePerSecondVariance;
    }

    public void setRotatePerSecondVariance(double rotatePerSecondVariance) {
    ...
    public double getRotationEndVariance() {
        return rotationEndVariance;
    }

    public void setRotationEndVariance(double rotationEndVariance) {
    ...
    public double getRotationStartVariance() {
        return rotationStartVariance;
    }

    public void setRotationStartVariance(double rotationStartVariance) {
        this.rotationStartVariance = rotationStartVariance;
    }

    public int getSourcePositionVariancex() {
        return sourcePositionVariancex;
    }

    public void setSourcePositionVariancex(int sourcePositionVariancex) {
        this.sourcePositionVariancex = sourcePositionVariancex;
    }

    public int getSourcePositionVariancey() {
        return sourcePositionVariancey;
    }

    public void setSourcePositionVariancey(int sourcePositionVariancey) {
    ...
    public void setSourcePositionx(double sourcePositionx) {
    ...
    public void setSourcePositiony(double sourcePositiony) {
    ...
    public double getStartParticleSize() {
        return startParticleSize;
    }

    public void setStartParticleSize(double startParticleSize) {
    ...
    public String getTextureImageData() {
        return textureImageData;
    }

    public void setTextureImageData(String textureImageData) {
        this.textureImageData = textureImageData;
    }
}

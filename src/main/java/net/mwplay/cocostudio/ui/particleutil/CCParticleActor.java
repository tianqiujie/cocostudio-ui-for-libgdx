...
public class CCParticleActor extends Actor implements Disposable {
    ...
    public CCParticleActor(String filePath,Texture texture){initWithFileAndTexture(filePath, texture);}
    @Override
...
//        m_tSourcePosition.y = y;
    ...
    public void setTexture(Texture texture){setTexture(texture,false);}
    public void setOpacityModifyRGB(boolean value){m_bOpacityModifyRGB = value;}
    public boolean isOpacityModifyRGB( ){return m_bOpacityModifyRGB;}
